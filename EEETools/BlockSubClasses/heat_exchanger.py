    ...
    def get_json_component_description(cls) -> dict:
        ...
        return {
            ...
            "handles": [
                ...
                {"id": "product input", "name": "product input", "type": "target", "position": "left",
                 "Category": "physical",
                 "single": False},
                {"id": "product output", "name": "product output", "type": "source", "position": "right",
                 "Category": "physical",
                 "single": False},
                {"id": "fuel input", "name": "fuel input", "type": "target", "position": "top", "Category": "physical",
                 "single": False},
                {"id": "fuel output", "name": "fuel output", "type": "source", "position": "bottom",
                 "Category": "physical",
                 "single": False},
