...
class CostCorrelationHandler(Handler):
    ...
    def __init__(self):
        ...
        self.subclasses_folder = os.path.join(costants.ROOT_DIR, "3ETool_res", "Cost Correlation Data")
        self.subclass_directory_path = "EEETools.Tools.EconomicModel.CostCorrelations.CorrelationClasses"
