from src.Tools.Other.handler import Handler
...
class ModulesHandler(Handler):
    ...
    def __init__(self):
        ...
        self.current_folder = os.path.join(costants.ROOT_DIR, "src", "Tools")
        self.data_folder = os.path.join(costants.ROOT_DIR, "res", "EES Code Data")
        self.subclass_directory_path = "src.BlockSubClasses"
